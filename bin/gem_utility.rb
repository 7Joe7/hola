...
if gem_name
  ...
  gem_build_name = `$(gem build #{gem_name}.gemspec |  awk '/File/ {print $2}' -)`
  ...
  puts 'You did not enter a gem name.  Please include it as an argument to the script or hard code it as a variable in the script.'
end